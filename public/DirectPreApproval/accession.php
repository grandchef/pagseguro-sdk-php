...
\GrandChef\Configuration\Configure::setLog(true, '/var/www/git/pagseguro/pagseguro-php-sdk/Log.log');

$preApproval = new \GrandChef\Domains\Requests\DirectPreApproval\Accession();
...
$preApproval->setSender()->setAddress()->withParameters('logradouro', 'numero', 'bairro', 'cep', 'cidade', 'UF',
    'BRA');//assinante
$document = new \GrandChef\Domains\DirectPreApproval\Document();
